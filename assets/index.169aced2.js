import{_ as u}from"./index.45380e8a.js";import{c as l,l as m,d as v}from"./webgl.0c8613b1.js";import{S as f}from"./Scene.937792a7.js";import{C as x,a as p}from"./Controls.faffc91e.js";import{T as d}from"./Transforms.f1923d0a.js";import"./mat4.7761f8fe.js";const g=`#version 300 es
...
void main(void) {
    ...
    fragColor = Ia + Id + Is;
}`,D="https://inokawa.github.io/webgl-practice/assets/fieldstone.4f2a53a3.jpg",T="https://inokawa.github.io/webgl-practice/assets/fieldstone-normal.06891319.jpg",E=async e=>{e.clearColor(.9,.9,.9,1),e.clearDepth(100),e.enable(e.DEPTH_TEST),e.depthFunc(e.LESS),e.disable(e.BLEND),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!0);const t=l(e,g,h,["aVertexPosition","aVertexNormal","aVertexTangent","aVertexTextureCoords"],["uProjectionMatrix","uModelViewMatrix","uNormalMatrix","uMaterialDiffuse","uMaterialAmbient","uLightAmbient","uLightDiffuse","uLightPosition","uSampler","uNormalSampler"]),o=new f(e,t);o.add(await u(()=>import("./cube-texture.5a84f6ea.js"),[]));const n=new x("ORBITING_TYPE");n.goHome([0,0,2]),n.setFocus([0,0,0]),n.setAzimuth(40),n.setElevation(-30),new p(n,e.canvas);const r=new d(t,n,e.canvas);t.use(),t.setUniform("uLightPosition","vec3",[0,5,20]),t.setUniform("uLightAmbient","vec4",[1,1,1,1]),t.setUniform("uLightDiffuse","vec4",[1,1,1,1]);const a=m(e,D),s=m(e,T);return o.start(c=>{e.viewport(0,0,e.canvas.width,e.canvas.height),e.clear(e.COLOR_BUFFER_BIT|e.DEPTH_BUFFER_BIT),r.updatePerspective();try{c.forEach(i=>{r.calculateModelView(),r.push(),r.setMatrixUniforms(),r.pop(),t.setUniform("uMaterialDiffuse","vec4",i.diffuse),t.setUniform("uMaterialAmbient","vec4",i.ambient),i.textureCoords&&(a.bind(0),t.setUniform("uSampler","sampler2D",0),s.bind(1),t.setUniform("uNormalSampler","sampler2D",1)),v(e,i.vao,"TRIANGLES")})}catch(i){console.error(i)}}),()=>{o.dispose(),a.dispose(),s.dispose()}};export{E as init};
